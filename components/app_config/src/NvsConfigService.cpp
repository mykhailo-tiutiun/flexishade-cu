...
std::expected<void, ConfigError> NvsConfigService::load(std::shared_ptr<Config> config) const
{
    esp_err_t err;
    nvs_handle_t handle;
...
std::expected<void, ConfigError> NvsConfigService::loadAll() const
{
    esp_err_t err;
    nvs_handle_t handle;
...
std::expected<void, ConfigError> NvsConfigService::save(std::shared_ptr<Config> config) const
{
    esp_err_t err;
    nvs_handle_t handle;
